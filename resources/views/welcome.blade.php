...
<body>
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="#nav">Home</a></li>
    ...
    <header class="bg-dark py-5" style="background-image: url('https://img.lovepik.com/background/20211022/large/lovepik-blue-premium-technology-theme-background-image_401952328.jpg');">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5" style="color: rgb(19, 170, 240)">
                        <h1 class="display-5 fw-bolder text-white mb-2">Buat Masa Depan Cerah Dengan Bantuan Teknologi
                            Kami</h1>
                        <p class="lead text-white-50 mb-4">Kami Membuat Agar Masa Depan Terlihat Cerah Dengan Teknologi
                        </p>
    ...
    <section class="py-5 border-bottom" id="about">
        <div class="container px-5 my-5">
            <div class="row gx-5">
                <div class="col-lg-12">
                    <h1 class="h1 fw-bolder">About Us</h1>
                    <p>Technova adalah pionir dalam dunia teknologi, berkomitmen untuk menghadirkan solusi inovatif yang
                        mampu mengubah cara Anda berbisnis. Dengan tim ahli yang berpengalaman dan bersemangat, kami
                        merancang, mengembangkan, dan mengimplementasikan solusi teknologi yang disesuaikan dengan
                        kebutuhan unik setiap klien.

                        Kami percaya bahwa teknologi seharusnya menjadi pendorong pertumbuhan dan efisiensi. Oleh karena
                        itu, kami senantiasa mengikuti perkembangan terkini dalam industri teknologi dan menerapkannya
                        dalam setiap proyek yang kami kerjakan. Baik itu pengembangan aplikasi mobile, pengembangan
                        website, atau implementasi sistem manajemen data, Technova siap menjadi mitra terpercaya Anda
                        dalam mencapai tujuan bisnis.</p>
                </div>
            </div>
        </div>
    </section>
